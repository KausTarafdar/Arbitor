...
export default function checkPortAndAccess(body) {
  if (
    ...
    throw new ValidationError("Check port type. Gateway accepts port type to be a string.");
  }
  else if (
    !(["private", "public"].includes(body.access_type))
  ) {
    throw new ValidationError("Check access_type value. Gateway accepts 'public' or 'private' values.");
  }
  else {
    return true;
  }
